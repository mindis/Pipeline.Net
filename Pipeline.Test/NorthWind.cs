...
SELECT A.[A1] AS [OrderDetailsDiscount]
	...
	,ISNULL(B.[B4], '0001-01-01') AS [OrdersOrderDate]
	,ISNULL(B.[B6], '0001-01-01') AS [OrdersRequiredDate]
	...
	,ISNULL(B.[B12], '0001-01-01') AS [OrdersShippedDate]
	...
	,ISNULL(D.[D2], '0001-01-01') AS [EmployeesBirthDate]
	...
	,ISNULL(D.[D8], '0001-01-01') AS [EmployeesHireDate]
	...
	,ISNULL(E.[E2], false) AS [ProductsDiscontinued]
